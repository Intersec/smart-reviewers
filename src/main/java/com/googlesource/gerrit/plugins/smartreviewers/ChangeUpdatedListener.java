...
class ChangeUpdatedListener implements ChangeListener {
  ...
  private final SmartReviewers.Factory smartReviewersFactory;
  ...
  public void onChangeEvent(ChangeEvent event) {
    ...
    try {
      ...
      try {
        ...
        final Runnable task =
            smartReviewersFactory.create(commit, change, ps, maxReviewers, weightBlame, weightLastReviews, weightWorkload, git, reviewDb);
